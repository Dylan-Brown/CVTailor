...
if (-not (Test-Path $ManifestPath)) {
    Write-Host "Could not find $ManifestPath -- copy com.thesistoolkit.cvtailor_intake.example.json" -ForegroundColor Red
    Write-Host "to com.thesistoolkit.cvtailor_intake.json in this folder first, then re-run." -ForegroundColor Red
    exit 1
}
