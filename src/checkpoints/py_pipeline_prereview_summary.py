#!/usr/bin/env python3
"""
py_pipeline_prereview_summary.py
================================
Provides a funnel summary across all prepared applications before Stage 8 manual review. 
Highlights red flags like zero surviving edits, thin ledgers, or low JD coverage.
