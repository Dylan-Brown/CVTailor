#!/usr/bin/env python3
"""
py_pipeline_status.py — where is everything in the pipeline right now.

Reads state off applications/ directly (the queue IS the folder set --
see batch_common's module docstring), not a separate tracking file.

Usage: python src/checkpoints/py_pipeline_status.py
"""
import json
import sys
