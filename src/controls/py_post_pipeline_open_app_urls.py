...
source_url (from jd_input.json / jd_input.processed.json) as a Chrome
tab, one window, no duplicates. Python rewrite of the old
open_app_urls.ps1 -- same behavior, now sharing batch_common's
APPLICATIONS_ROOT/app_dirs instead of re-deriving the applications/
path convention separately.
