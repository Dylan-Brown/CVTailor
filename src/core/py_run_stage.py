#!/usr/bin/env python3
"""
py_run_stage.py -- the one place that knows how to run a stage script
as a subprocess, given a stage number and argv. batch_common.py imports
sh()/stage_script() from here rather than redefining them.
"""
