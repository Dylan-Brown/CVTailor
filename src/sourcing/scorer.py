#!/usr/bin/env python3
"""
sourcing/scorer.py -- JobScorer: deterministic job-fit scoring plus one
LLM resume-fit call via core/llm_dispatch. Used by
src/stages/py_stage01_score_jd_input.py, not run directly.
"""
