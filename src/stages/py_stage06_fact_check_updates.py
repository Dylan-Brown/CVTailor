#!/usr/bin/env python3
"""
py_stage07_evaluate_update_utility.py — Stage 7: Edit Utility Critique
======================================================================
The utility gate. Runs between Stage 6 (Fact-Check) and Stage 8 (Human Review).

While Stage 6 ensures an edit is *true*, this stage evaluates whether an edit 
is actually *useful* for this specific job. It aggressively culls weak or 
purely superficial synonym swaps so they don't crowd out high-value edits during 
human review. 

Cut edits are logged to `critiqued_out.jsonl` with reasoning.
